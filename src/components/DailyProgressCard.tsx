            ...
            <div className="rounded-xl border border-slate-700 bg-slate-800/70 p-4 shadow-hud">
                <div className="flex items-stretch justify-between gap-4">
                    <div className="flex min-w-0 flex-1 flex-col justify-center">
                        <p className="text-xs uppercase tracking-[0.24em] text-slate-500 font-heading">Today's Quest Progress</p>
                        <div className="mt-1 flex items-baseline gap-2">
                            <span className="text-2xl font-heading text-white">{completed}/{total}</span>
                            <span className="text-sm text-slate-400">daily quests cleared</span>
                        </div>
                        <button
                            type="button"
                ...
                <div className="fixed inset-0 z-[70] flex items-center justify-center bg-slate-950/75 p-4 animate-in fade-in duration-200">
                    <div className="max-h-[calc(100dvh-2rem)] w-full max-w-sm overflow-y-auto rounded-2xl border border-slate-700 bg-slate-900 p-5 shadow-xl animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-slate-300">
                            Clear at least <span className="font-mono text-amber-400">{dailyRule.thresholdLabel}</span> of your active dailies
                        ...
                        <p className="mt-3 text-sm leading-relaxed text-slate-400">
                            If you fall short, each unfinished daily can cost HP overnight. Streak freezes still protect you if you have one.
                        </p>
                        <button
                            type="button"
